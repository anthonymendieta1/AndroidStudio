...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgResult=(ImageView) findViewById(R.id.resultImagen);
        btnLanzar =(Button) findViewById(R.id.buttonLanzar);
        btnLanzar.setOnClickListener(this);
        resultText=(TextView) findViewById(R.id.textResult);
        btnThrow=(Button) findViewById(R.id.buttonThrow);
        btnThrow.setOnClickListener(this);
    }
    public void Accion(View view){
        if(btnThrow==view){
            Random aleatorio=new Random();
            int random=aleatorio.nextInt(20)+1;
            resultText.setText(""+random);
        }
    }
    @Override
